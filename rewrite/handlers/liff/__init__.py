...
from rewrite.handlers.liff import health, customer, booking, import_form, fixed_schedule, report, accounting, batch_allowance, drug_diagnosis_links, trip  # noqa: E402, F401
