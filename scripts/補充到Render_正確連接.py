...
def add_single_fixed_trip_render(fixed_schedule_id, target_dates=None):
    """
...
def main():
    ...
    print("🚌 開始補充固定班次 ID=54 到 Render 線上資料庫（正確連接）...")
    print("=" * 70)
    print(f"🔗 使用連接：dispatch_system_db @ singapore-postgres.render.com")
    print("=" * 70)
    
    # 補充 ID=54 的固定班次
    success_count, error_messages = add_single_fixed_trip_render(54)
