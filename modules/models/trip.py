...
class Trip(db.Model):
    ...
    passenger_leave_reason = db.Column(db.Text, nullable=True)
    trip_type = db.Column(db.String(20), default='fixed')
    custom_start_point = db.Column(db.String(100), nullable=True)
    custom_via_point = db.Column(db.String(100), nullable=True)
    custom_end_point = db.Column(db.String(100), nullable=True)
    modified_by = db.Column(db.Text, nullable=True)
    modification_reason = db.Column(db.Text, nullable=True)
    modification_time = db.Column(db.DateTime, nullable=True)
    passenger_name = db.Column(db.Text, nullable=True)
...
class CompletedTrip(db.Model):
    ...
    unique_code = db.Column(db.String(50))
    passenger_leave_reason = db.Column(db.Text, nullable=True)
    trip_type = db.Column(db.String(20), nullable=True)
