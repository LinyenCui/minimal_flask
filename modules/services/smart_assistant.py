...
範例1: "明天司機5386所有班次" ⭐ 未來日期默認現在態
生產線分析: 查詢明天已匯入到生產線上的該司機所有產品
時間態: 現在 (明天≥今天，默認查生產線，除非明確說「已完成」)
目標表: trips
命令: "查詢班次 明天 司機5386"
重要: 明天不可能有真正已完成的班次，應顯示狀態統計
...
範例5: "7/30司機5386班次" ⭐ 關鍵：過去具體日期查詢
生產線分析: 查詢7/30(過去日期)該司機的班次，這些班次應該已執行完畢
時間態: 過去 (過去日期的班次已掉入成品倉庫)
目標表: completed_trips
命令: "查已完成 7/30 司機5386"
重要提醒: 過去的具體日期(小於今天8/1)都查completed_trips，不管有無金額關鍵字

範例5.1: "7/29司機5386班次" ⭐ 另一個過去日期查詢範例
生產線分析: 查詢7/29(過去日期)該司機的班次，這些班次應該已執行完畢
時間態: 過去 (過去日期的班次已掉入成品倉庫)
目標表: completed_trips
命令: "查已完成 7/29 司機5386"

範例5.2: "7/28司機5386班次" ⭐ 再一個過去日期查詢範例
生產線分析: 查詢7/28(過去日期)該司機的班次，這些班次應該已執行完畢
時間態: 過去 (過去日期的班次已掉入成品倉庫)
目標表: completed_trips
命令: "查已完成 7/28 司機5386"

範例5.3: "7/28-7/30 5386班次" ⭐ 關鍵：跨日期範圍查詢（過去態）
生產線分析: 查詢7/28到7/30期間該司機的所有班次（過去日期範圍）
時間態: 過去 (過去日期範圍的班次已掉入成品倉庫)
目標表: completed_trips
命令: "查已完成範圍 7/28-7/30 司機5386"
重要提醒: 跨日期範圍查詢使用"查已完成範圍"命令，一次查詢多天數據

範例5.4: "8/1-8/5 5386班次" ⭐ 關鍵：跨日期範圍查詢（現在態）
生產線分析: 查詢8/1到8/5期間該司機的所有班次（今天及未來日期範圍）
時間態: 現在 (今天及未來日期範圍的班次在生產線上)
目標表: trips
命令: "查班次範圍 8/1-8/5 司機5386"
重要提醒: 現在/未來日期範圍查詢使用"查班次範圍"命令
...
範例8.8: "7/30司機5386診所班次" ⭐ 重要：未來具體日期查詢
生產線分析: 查詢7/30(未來日期)該司機診所班次，這些班次在生產線上等待執行
時間態: 現在 (7/30≥今天，未來日期默認查生產線，不可能有已完成)
目標表: trips
命令: "查詢班次 7/30 司機5386 診所"
